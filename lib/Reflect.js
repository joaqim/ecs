...
export function Model(constructorOrName) {
...
export function Primed(factory, propertyOptions = {}) {
...
export class Base {
    ...
    init(payload = {}, trace = new Set()) {
        ...
        for (const key in primedProperties) {
            ...
            const classNameMappingMedatada = Reflect.getMetadata(CLASS_NAME_MAPPING, Base.constructor);
