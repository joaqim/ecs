...
let Entity = class Entity extends primed_model_1.Base {
    id;
    listeners = [];
    componentMap;
...
tslib_1.__decorate([
    primed_model_1.Primed(exports.PrimedId, { required: true })
], Entity.prototype, "id", void 0);
tslib_1.__decorate([
    primed_model_1.Primed(PrimedComponentMap)
], Entity.prototype, "components", null);
Entity = tslib_1.__decorate([
    primed_model_1.Model("Entity")
], Entity);
